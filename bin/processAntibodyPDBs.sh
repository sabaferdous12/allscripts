...
#   File:       processAntibodyPDBs.sh 
#                                                                               
#   Version:    V1.1                                                            
#   Date:       22.04.14                                                        
#   Function:   This is an automatic pipeline to process the Data for AbDb
#               It generates data for all the numbering schemes 
#   Usage:      ./processAntibodyPDBs.sh                                                 
#                                                                               
#                                                                               
